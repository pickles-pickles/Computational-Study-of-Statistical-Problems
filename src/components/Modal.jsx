        ...
        <React.Fragment>
            <div className="card mt-2">
                <div className="card-head">
                    <button className="btn btn-secondary"><span /* className="fa fa-window-close" */
                    onClick={()=> {setIsModalOpen(false)}}
                    >Close</span></button>
                    
                </div>
                <div className="card-body">
                    This littlle paragraph has some info about the App. This App works using the Javascript random numbers generator.
